...
!(function ( $ ) {
    ...
    Datepicker.prototype = {
        ...
        show: function(e) {
            this.picker.data('datepicker-show', true).show();
        ...
        update: function(){
            ...
            if (this.withPeriod) {
                this.period = this.element.data('date-period');
            }
            this.fill();
        },
        ...
        fill: function() {
            var d = new Date(this.viewDate),
                ...
                today = (new Date(moment().year(), moment().month(),moment().date(), 0,0,0)).valueOf();
            ...
            if (this.withPeriod) {
                $('.datepicker-period input[name="period"][value="' + this.period + '"]', this.picker).attr('checked', 'checked');
            }
        },
        ...
        click: function(e) {
            e.stopPropagation();
            e.preventDefault();
            var target = $(e.target).closest('span, td, th, label, input');
            if (target.length == 1) {
    ...
    $.fn.datepicker.DPGlobal.template = [
        ...
        '<tbody></tbody>',
        '</table>',
        '<div class="datepicker-period hide"><b>Period:</b><form class="form-inline">',
